...
C_SRCS += \
../Core/Src/lvgl/src/extra/lv_extra.c 

C_DEPS += \
./Core/Src/lvgl/src/extra/lv_extra.d 

OBJS += \
./Core/Src/lvgl/src/extra/lv_extra.o 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/lvgl/src/extra/%.o Core/Src/lvgl/src/extra/%.su Core/Src/lvgl/src/extra/%.cyclo: ../Core/Src/lvgl/src/extra/%.c Core/Src/lvgl/src/extra/subdir.mk
...
clean: clean-Core-2f-Src-2f-lvgl-2f-src-2f-extra

clean-Core-2f-Src-2f-lvgl-2f-src-2f-extra:
	-$(RM) ./Core/Src/lvgl/src/extra/lv_extra.cyclo ./Core/Src/lvgl/src/extra/lv_extra.d ./Core/Src/lvgl/src/extra/lv_extra.o ./Core/Src/lvgl/src/extra/lv_extra.su

.PHONY: clean-Core-2f-Src-2f-lvgl-2f-src-2f-extra
